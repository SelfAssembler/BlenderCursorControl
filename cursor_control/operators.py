...
class VIEW3D_OT_cursor_to_active_object_center(bpy.types.Operator):
    ...
    def execute(self, context):
        cc = context.scene.cursor_control
        cc.hideLinexChoice()
        cc.setDelta(context.active_object.location)
        return {'FINISHED'}
...
#class VIEW3D_OT_cursor_delta_show(bpy.types.Operator):
    #'''Show cursor delta'''
    #bl_idname = "view3d.cursor_delta_show"
    #bl_label = "Show cursor delta"
    #bl_options = {'REGISTER'}
    ...
    #def execute(self, context):
        #cc = context.scene.cursor_control
        #cc.deltaLocationDraw = 1
        #BlenderFake.forceRedraw()
        #return {'FINISHED'}



#class VIEW3D_OT_cursor_delta_hide(bpy.types.Operator):
    #'''Hide cursor delta'''
    #bl_idname = "view3d.cursor_delta_hide"
    #bl_label = "Hide cursor delta"
    #bl_options = {'REGISTER'}
    ...
    #def execute(self, context):
        #cc = context.scene.cursor_control
        #cc.deltaLocationDraw = 0
        #BlenderFake.forceRedraw()
        #return {'FINISHED'}



class VIEW3D_OT_cursor_delta_toggledraw(bpy.types.Operator):
    '''Toggle cursor delta'''
    bl_idname = "view3d.cursor_delta_toggledraw"
    bl_label = "Toggle cursor delta"
    bl_options = {'REGISTER'}
    ...
    def execute(self, context):
        cc = context.scene.cursor_control
        cc.deltaLocationDraw = not cc.deltaLocationDraw
        BlenderFake.forceRedraw()
        return {'FINISHED'}
