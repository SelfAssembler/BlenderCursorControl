...
class CursorControlData(bpy.types.PropertyGroup):
    # Target
    setDeltaEnable = bpy.props.BoolProperty(name="Set delta vector",description="Set delta vector",default=0)
    ...
    deltaLocationDraw = bpy.props.BoolProperty(description="Draw delta 3D view",default=1)
